...
whichare the most commonly usedme trics, to evaluate the
...
but the algorithm itself is more complex and harder to understand. PCA and
clustering-based methods have high precision score but low in recall, there for
