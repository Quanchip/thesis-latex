...
Firure 2.1 show a log snippet that was generated by HDFS DataNode, one of the core storage components in the Hadoop ecosystem
...
data writes, packet handling, and communication beetween DataNodes. A log entry typically follow a structure as follow:
...
centrally strored and appropriately maintained  to enable accurate monitoring, troubleshooting, and subsequent analytical processes.
...
when the system complexity and log volumes were much smaller than nowadays modern systems. Understanding the strenghts and limitations of
...
- rule-based systems (regex, pattern)
